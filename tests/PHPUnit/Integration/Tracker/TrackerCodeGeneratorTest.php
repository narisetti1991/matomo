...
{
    public function testJavascriptTrackingCode_withAllOptions_forDomainWith_WWW()
    {
...
";
    ...
    public function testJavascriptTrackingCode_withAllOptions_forDomainWithout_WWW()
    {
        $generator = new TrackerCodeGenerator();
